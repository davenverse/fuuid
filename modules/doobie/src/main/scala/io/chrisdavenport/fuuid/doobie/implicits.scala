...
object implicits {
  ...
  @deprecated(message = "You should not demand a Meta implicitly. Please use FuuidGet or FuuidPut instead.", since = "0.5.1")
  ...
  @deprecated(message = "You should not demand a Meta implicitly. Please use FuuidGet or FuuidPut instead.", since = "0.6.1")
